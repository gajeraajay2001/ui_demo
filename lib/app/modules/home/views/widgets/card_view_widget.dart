  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      margin: EdgeInsets.symmetric(
          horizontal: MySize.getWidth(10), vertical: MySize.getHeight(10)),
      child: ClipRRect(
        borderRadius: BorderRadius.circular(
          MySize.getHeight(20),
        ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                                  ...
                                  ? GoogleMap(
                                      ...
                                      onTap: (value) {
                                        Get.toNamed(Routes.MAP_SCREEN,
                                            arguments: {
                                              "lat":
                                                  widget.properties.latitude!,
                                              "long":
                                                  widget.properties.longitude!,
                                            });
                                      },
                      ...
                      Spacing.height(20),
                      if (!isNullEmptyOrFalse(widget.properties.keyFeatures))
                        KeyAndFeatureWidget(
                            keyFeatureList: widget.properties.keyFeatures!),
                      Spacing.height(20),
                      if (!isNullEmptyOrFalse(widget.properties.propertyImages))
                        GalleryCarouselWidget(
                            propertyImages: widget.properties.propertyImages!),
                      Spacing.height(20),
